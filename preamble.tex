...
\definecolor{lmu-green}{RGB}{0,136,58}
\definecolor{lmu-green2}{RGB}{0,136,58}
\setbeamercolor{title}{fg=lmu-green}
\setbeamercolor{frametitle}{fg=lmu-green}
\setbeamercolor{structure}{fg=lmu-green}
\setbeamercolor{section in head/foot}{fg=lmu-green, bg=lightgray!20}
\setbeamercolor{title}{bg={lightgray!20}} % {} = transparent
\setbeamercolor{button}{bg={lightgray!30},fg=lmu-green}

%% TITLE FRAME
\setbeamertemplate{title page}
{
        \vspace{15mm}
        {\usebeamerfont{title}\usebeamercolor[lmu-green]{title}\Large\inserttitle}\\
        {\usebeamerfont{subtitle}\usebeamercolor[lmu-green]{subtitle}\large\insertsubtitle}\\ \vspace{7mm}
        {\insertauthor}\\
...
%\newtcbtheorem{finding}{\color{lmu-green}Puzzle}{colback=white,colframe=lightgray!30,fonttitle=\bfseries,sharp corners}{th}
