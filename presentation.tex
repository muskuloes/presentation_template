...
\tikz[overlay,remember picture]\node[opacity=0.2, at=(current page.south east)] {
\includegraphics[width=.6\paperwidth,height=.8\paperheight]{figures/sigillum.png}};
}
...
{
	\setbeamercolor{background canvas}{bg=lmu-green}
	\begin{frame}[plain]		
    	\vspace{1cm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
    ...
    \begin{frame}[plain]		
    	...
    	\hspace{7cm}\circled{{\color{lmu-green}\fontsize{8}{9}\faEnvelope}} \hspace{.1cm} {\footnotesize \color{white} \href{mailto:#}{name@institution.com}}\\ % für 16:9 10cm
    	\hspace{7cm}\circled{{\color{lmu-green}\footnotesize\faTwitter}} \hspace{.1cm} {\footnotesize \color{white} \href{#}{TwitterHandle}}\\ % für 16:9 10cm
    	\hspace{7cm}\circled{{\color{lmu-green}\footnotesize\faHome}} \hspace{.1cm} {\footnotesize \color{white} \href{#}{yourwebsite.com}}\\ % für 16:9 10cm
    \end{frame}
    \addtocounter{framenumber}{-1}
}
